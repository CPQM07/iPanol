 ...
 <!-- Bootstrap 3.3.6 -->
<script src="<?= base_url('resources/plugins/bootstrap/js/bootstrap.min.js') ?>"></script>
 <!-- jQuery UI 1.11.4 -->
...
<!-- AdminLTE App -->
<script src="<?= base_url('resources/plugins/dist/js/app.min.js')  ?>"></script>
<!-- Sparkline -->
...
<!-- pNotify -->
<script src="<?= base_url('resources/js/pnotify.custom.min.js')  ?>"></script><!-- charjs -->