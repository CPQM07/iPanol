                  ...
                  <form name="form1" id="new_form" class="form-horizontal" action="<?=site_url('Mantencion/new_usuario')?>" method="post" accept-charset="utf-8" >
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="row">
                        <div class="col-md-6">
                          <input id="rut" type="text" name="new_usu[USU_RUT]" class="col-md-12 form-control" placeholder="Rut sin punto, ni guion" pattern="[0-9]{7,8}" maxlength = "8" required>
                          </div>
                          <div class="col-md-2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <select placeholder="Seleccionar cargo..." id="new_cargo" name="new_usu[USU_CARGO_ID]" class="select2" style="width: 100%;" required>
                            <option></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <select placeholder="Seleccionar carrera..." id="new_carrera" name="new_usu[USU_CARRERA_ID]" class="select2" style="width: 100%;" required>
                            <option></option>
